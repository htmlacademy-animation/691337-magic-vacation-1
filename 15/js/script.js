...
class AccentTypography {
  ...
  prepareAnimation() {
    _constants__WEBPACK_IMPORTED_MODULE_0__["ACCENT_TYPOGRAPHY_SELECTORS"].forEach((it) => {
...
class Animation {
  constructor(options) {
    ...
    if (!this.options.easing) {
      this.options.easing = _utils_js__WEBPACK_IMPORTED_MODULE_0__["timingFunctions"].easeLinear;
    }
...
/*!****************************************!*\
  !*** ./source/js/modules/constants.js ***!
  \****************************************/
/*! exports provided: COMMON_ORDER, RULES_ORDER, INTRO_ORDER, DATE_ORDER, ACCENT_TYPOGRAPHY_SELECTORS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COMMON_ORDER", function() { return COMMON_ORDER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RULES_ORDER", function() { return RULES_ORDER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INTRO_ORDER", function() { return INTRO_ORDER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DATE_ORDER", function() { return DATE_ORDER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ACCENT_TYPOGRAPHY_SELECTORS", function() { return ACCENT_TYPOGRAPHY_SELECTORS; });
const COMMON_ORDER = [3, 1, 0, 1, 2, 1, 0, 4, 2, 0, 2, 0];
const RULES_ORDER = [4, 2, 1, 0, 3, 2, 0];
const INTRO_ORDER = [3, 4, 2, 0, 3, 1];
const DATE_ORDER = [3, 2, 0, 2, 0, 4, 1, 5, 2, 5, 0, 2, 0, 0, 4, 3, 1];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Scene2DCroco; });
...
class Scene2DCroco extends _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
  ...
  initKeyAnimations() {
    this.animations.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      delay: DELAY_S,
      easing: _utils_js__WEBPACK_IMPORTED_MODULE_2__["timingFunctions"].easeLinear
    }));
  }
  ...
  initCrocoAnimations() {
    this.animations.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      easing: _utils_js__WEBPACK_IMPORTED_MODULE_2__["timingFunctions"].easeInCubic
    }));
  }
  ...
  initFlamingoAnimations() {
    this.animations.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: ANIM_DURATION_M,
      delay: DELAY_L,
      easing: _utils_js__WEBPACK_IMPORTED_MODULE_2__["timingFunctions"].easeOutExpo
    }));
...
/***/ "./source/js/modules/game-screen.js":
/*!******************************************!*\
  !*** ./source/js/modules/game-screen.js ***!
  \******************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/prizes-screen.js":
/*!********************************************!*\
  !*** ./source/js/modules/prizes-screen.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PrizesScreen; });
class PrizesScreen {
  constructor() {
...
/***/ "./source/js/modules/result-title.js":
/*!*******************************************!*\
  !*** ./source/js/modules/result-title.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sea_calf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sea-calf.js */ "./source/js/modules/sea-calf.js");
/* harmony import */ var _croco_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./croco.js */ "./source/js/modules/croco.js");
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        if (target === `result`) {
          const scene = new _sea_calf_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
          scene.init();
        }

        if (target === `result3`) {
          const scene = new _croco_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
          scene.init();
        }
      });
    }
...
const IMG_PATH = `./img/module-4/win-primary-images`;

const IMAGES_URLS = Object.freeze({
  plane: `${IMG_PATH}/airplane.png`,
  tree: `${IMG_PATH}/tree.png`,
  tree2: `${IMG_PATH}/tree-2.png`,
  ice: `${IMG_PATH}/ice.png`,
  seaCalf: `${IMG_PATH}/sea-calf-2.png`,
  snowflake: `${IMG_PATH}/snowflake.png`
});
...
class Scene2DSeaCalf extends _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  initPlaneAnimations() {
    this.animations.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 500,
      delay: 1200,
      easing: _utils_js__WEBPACK_IMPORTED_MODULE_2__["timingFunctions"].easeInQuad
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 2000,
      delay: 1000,
      easing: _utils_js__WEBPACK_IMPORTED_MODULE_2__["timingFunctions"].easeOutElastic
    }));
...
/***/ "./source/js/modules/story-screen.js":
/*!*******************************************!*\
  !*** ./source/js/modules/story-screen.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StoryScreen; });
class StoryScreen {
  constructor() {
...
/*!************************************!*\
  !*** ./source/js/modules/utils.js ***!
  \************************************/
/*! exports provided: timingFunctions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _modules_accent_typography_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/accent-typography.js */ "./source/js/modules/accent-typography.js");
/* harmony import */ var _modules_story_screen_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/story-screen.js */ "./source/js/modules/story-screen.js");
/* harmony import */ var _modules_game_screen_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/game-screen.js */ "./source/js/modules/game-screen.js");
/* harmony import */ var _modules_result_title_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/result-title.js */ "./source/js/modules/result-title.js");
/* harmony import */ var _modules_prizes_screen_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/prizes-screen.js */ "./source/js/modules/prizes-screen.js");
// modules
...
Object(_modules_result_title_js__WEBPACK_IMPORTED_MODULE_13__["default"])();

const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_8__["default"]();
fullPageScroll.init();

const accentTypography = new _modules_accent_typography_js__WEBPACK_IMPORTED_MODULE_10__["default"]();
accentTypography.init();

const storyScreen = new _modules_story_screen_js__WEBPACK_IMPORTED_MODULE_11__["default"]();
storyScreen.init();

const gameScreen = new _modules_game_screen_js__WEBPACK_IMPORTED_MODULE_12__["default"]();
gameScreen.init();

const prizesScreen = new _modules_prizes_screen_js__WEBPACK_IMPORTED_MODULE_14__["default"]();
prizesScreen.init();
